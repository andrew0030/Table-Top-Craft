...
public class ChessTileInfoColorScreen extends BaseScreen implements IColorPicker
{
	...
	private static final Component TITLE = Component.translatable("gui.table_top_craft.chess.color.tile_info");
	...
	public ChessTileInfoColorScreen(ChessBlockEntity chessBlockEntity, boolean isColorPickerActive)
	{
	...
	protected void init()
	{
	    ...
	    // RGB Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(this.x + 5, this.y + 74, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getTileInfoColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(this.x + 5, this.y + 87, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getTileInfoColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(this.x + 5, this.y + 100, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getTileInfoColor()), this));
		// The Color Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, this.x + 69, this.y + 33));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.TILE_INFO_COLOR, this, this.x + 69, this.y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.TILE_INFO, this.chessBlockEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.x + 90, this.y + 113));
		// The Color Picker
	...
	public void renderScreenContents(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
	{
		...
		graphics.setColor((1F / 255F) * this.redColorSlider.getValueInt(), (1F / 255F) * this.greenColorSlider.getValueInt(), (1F / 255F) * this.blueColorSlider.getValueInt(), 1.0F);
