...
{
	public static final BlockEntityType<ChessTileEntity> CHESS                              = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Reference.MODID, "chess"), FabricBlockEntityTypeBuilder.create(ChessTileEntity::new, TTCTileEntities.getBlocksOfClass(ChessBlock.class)).build(null));
