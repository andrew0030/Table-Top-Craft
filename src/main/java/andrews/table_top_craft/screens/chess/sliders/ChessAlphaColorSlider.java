...
{
	private final static TranslationTextComponent alphaValueText = new TranslationTextComponent("gui.table_top_craft.chess.sliders.alpha");

	public ChessAlphaColorSlider(int xPos, int yPos, int width, int height, int currentValue)
	{
		super(xPos, yPos, width, height, alphaValueText, new StringTextComponent(""), 26, 255, currentValue, false, true, slider -> {});
	}
