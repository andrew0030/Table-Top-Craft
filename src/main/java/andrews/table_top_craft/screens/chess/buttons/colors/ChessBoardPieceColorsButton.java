...
public class ChessBoardPieceColorsButton extends Button
{
	...
	private final String buttonText = new TranslationTextComponent("gui.table_top_craft.chess.color.button.piece").getString();
	...
	public ChessBoardPieceColorsButton(ChessTileEntity tileEntity, int xPos, int yPos) 
	{
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessBoardPieceColorsScreen(chessTileEntity));
	}
}