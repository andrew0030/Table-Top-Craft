...
public class ChessBoardInvalidMoveColorButton extends Button
{
	...
	private final String buttonTileInfoColorText = Component.translatable("gui.table_top_craft.chess.color.button.invalid_move").getString();
	...
	public ChessBoardInvalidMoveColorButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
