...
public class ChessBoardInvalidMoveColorScreen extends BaseScreen implements IColorPicker
{
	...
	private static final Component TITLE = Component.translatable("gui.table_top_craft.chess.color.invalid_move");
	...
	protected void init()
	{
		...
		// RGBA Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(this.x + 5, this.y + 61, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(this.x + 5, this.y + 74, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(this.x + 5, this.y + 87, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(this.x + 5, this.y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessBlockEntity.getInvalidMoveColor())));
		// The Color Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, this.x + 69, this.y + 33));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.INVALID_MOVE, this, this.x + 69, this.y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.INVALID_MOVE, this.chessBlockEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, this.x + 90, this.y + 113));
		// The Color Picker
