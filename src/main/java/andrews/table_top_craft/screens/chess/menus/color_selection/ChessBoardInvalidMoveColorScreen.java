...
public class ChessBoardInvalidMoveColorScreen extends Screen
{
	...
	public ChessBoardInvalidMoveColorScreen(ChessTileEntity chessTileEntity)
	{
	...
	protected void init()
	{
	    ...
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getInvalidMoveColor())));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getInvalidMoveColor())));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getInvalidMoveColor())));
	    ...
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.INVALID_MOVE, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 69, y + 47));
