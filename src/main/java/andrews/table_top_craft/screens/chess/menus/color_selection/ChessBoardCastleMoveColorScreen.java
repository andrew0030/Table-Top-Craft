...
public class ChessBoardCastleMoveColorScreen extends Screen
{
	...
	protected void init()
	{
	    ...
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getCastleMoveColor())));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getCastleMoveColor())));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getCastleMoveColor())));
	    ...
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.CASTLE_MOVE, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 69, y + 47));
