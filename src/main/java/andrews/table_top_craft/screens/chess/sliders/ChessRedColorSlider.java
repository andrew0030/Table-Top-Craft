...
public class ChessRedColorSlider extends Slider
{
	private final static TranslationTextComponent redValueText = new TranslationTextComponent("gui.table_top_craft.chess.sliders.red");

	public ChessRedColorSlider(int xPos, int yPos, int width, int height, int currentValue)
	{
		super(xPos, yPos, width, height, redValueText, new StringTextComponent(""), 1, 255, currentValue, false, true, slider -> {});
	}
