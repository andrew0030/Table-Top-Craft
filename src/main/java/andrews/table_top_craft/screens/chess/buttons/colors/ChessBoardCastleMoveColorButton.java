...
public class ChessBoardCastleMoveColorButton extends Button
{
	...
	private final String buttonTileInfoColorText = new TranslatableComponent("gui.table_top_craft.chess.color.button.castle_move").getString();
	...
	{
		Minecraft.getInstance().setScreen(new ChessBoardCastleMoveColorScreen(chessTileEntity));
	}
}