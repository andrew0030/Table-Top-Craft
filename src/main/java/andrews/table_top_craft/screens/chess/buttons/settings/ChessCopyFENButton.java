...
public class ChessCopyFENButton extends Button
{
	...
	private final String buttonText = new TranslatableComponent("gui.table_top_craft.chess.copy_fen").getString();
	...
	public ChessCopyFENButton(ChessTileEntity tileEntity, int xPos, int yPos) 
	{
