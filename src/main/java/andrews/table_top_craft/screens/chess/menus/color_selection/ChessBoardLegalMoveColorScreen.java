...
public class ChessBoardLegalMoveColorScreen extends BaseScreen implements IColorPicker
{
	...
	private static final Component TITLE = Component.translatable("gui.table_top_craft.chess.color.legal_move");
	...
	public ChessBoardLegalMoveColorScreen(ChessBlockEntity chessBlockEntity, boolean isColorPickerActive)
	{
	...
	protected void init()
	{
	    ...
	    // RGBA Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(this.x + 5, this.y + 61, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(this.x + 5, this.y + 74, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(this.x + 5, this.y + 87, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(this.x + 5, this.y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessBlockEntity.getLegalMoveColor())));
		// The Color Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, this.x + 69, this.y + 33));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.LEGAL_MOVE, this, this.x + 69, this.y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.LEGAL_MOVE, this.chessBlockEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, this.x + 90, this.y + 113));
		// The Color Picker
	...
	{
		return redColorSlider;
	}

	@Override
	public BaseSlider getGreenSlider()
	{
		return greenColorSlider;
	}

	@Override
	public BaseSlider getBlueSlider()
	{
		return blueColorSlider;
	}
