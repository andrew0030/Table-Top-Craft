...
public class ChessTileInfoColorsButton extends Button
{
	...
	private final String buttonTileInfoColorText = Component.translatable("gui.table_top_craft.chess.color.button.tile_info").getString();
	...
	public ChessTileInfoColorsButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
