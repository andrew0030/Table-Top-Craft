...
public class ChessLoadFENButton extends Button
{
	...
	private final String buttonText = Component.translatable("gui.table_top_craft.chess.load_fen").getString();
	...
	public ChessLoadFENButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
	...
	{
		Minecraft.getInstance().setScreen(new ChessLoadFENScreen(chessBlockEntity));
	}
}