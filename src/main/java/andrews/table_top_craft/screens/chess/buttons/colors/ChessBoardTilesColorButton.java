...
public class ChessBoardTilesColorButton extends Button
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/gui/buttons/chess_menu_buttons.png");
	private final String buttonText = new TranslationTextComponent("gui.table_top_craft.chess.color.button.tiles").getString();
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessBoardTilesColorScreen(chessTileEntity));
	}
}