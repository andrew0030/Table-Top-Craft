...
public class ChessBoardAttackMoveColorScreen extends Screen implements IColorPicker
{
	...
	public ChessBoardAttackMoveColorScreen(ChessTileEntity chessTileEntity, boolean isColorPickerActive)
	{
	...
	protected void init()
	{
		...
		// RGBA Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getAttackMoveColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getAttackMoveColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getAttackMoveColor()), this));
	    ...
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.ATTACK_MOVE, this, x + 69, y + 47));
