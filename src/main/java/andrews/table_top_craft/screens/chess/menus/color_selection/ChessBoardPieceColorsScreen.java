...
public class ChessBoardPieceColorsScreen extends BaseScreen implements IColorPicker, IColorPickerExtended
{
	...
	private static final Component TITLE = Component.translatable("gui.table_top_craft.chess.color.piece");
	private static final Component PREVIEW_COLOR_TXT = Component.translatable("gui.table_top_craft.chess.color.colors_preview");
	private static final Component WHITE_PIECE_SETTINGS_TXT = Component.translatable("gui.table_top_craft.chess.color.white_piece_settings");
	private static final Component BLACK_PIECE_SETTINGS_TXT = Component.translatable("gui.table_top_craft.chess.color.black_piece_settings");
	...
	protected void init()
	{
		...
		// RGB Sliders
	    this.addRenderableWidget(this.whiteRedColorSlider = new ChessRedColorSlider(this.x + 5, this.y + 92, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getWhitePiecesColor()), this));
	    this.addRenderableWidget(this.whiteGreenColorSlider = new ChessGreenColorSlider(this.x + 5, this.y + 105, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getWhitePiecesColor()), this));
	    this.addRenderableWidget(this.whiteBlueColorSlider = new ChessBlueColorSlider(this.x + 5, this.y + 118, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getWhitePiecesColor()), this));
	    this.addRenderableWidget(this.blackRedColorSlider = new ChessRedColorSlider(this.x + 5, this.y + 141, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getBlackPiecesColor()), this));
	    this.addRenderableWidget(this.blackGreenColorSlider = new ChessGreenColorSlider(this.x + 5, this.y + 154, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getBlackPiecesColor()), this));
	    this.addRenderableWidget(this.blackBlueColorSlider = new ChessBlueColorSlider(this.x + 5, this.y + 167, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getBlackPiecesColor()), this));
		// The Color Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, this.x + 5, this.y + 68));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.PIECES, this, this.x + 90, this.y + 68));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.PIECES, this.chessBlockEntity, this.whiteRedColorSlider, this.blackRedColorSlider, this.whiteGreenColorSlider, this.blackGreenColorSlider, this.whiteBlueColorSlider, this.blackBlueColorSlider, this.x + 90, this.y + 180));
		// The Color Pickers
	...
	public void renderScreenContents(GuiGraphics graphics, int mouseX, int mouseY, float partialTick)
	{
		...
		graphics.drawString(this.font, WHITE_PIECE_SETTINGS_TXT, this.x + 5, this.y + 83, 0x000000, false);
		graphics.drawString(this.font, BLACK_PIECE_SETTINGS_TXT, this.x + 5, this.y + 132, 0x000000, false);
	}
