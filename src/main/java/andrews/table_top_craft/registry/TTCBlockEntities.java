...
{
	public static final BlockEntityType<ChessTileEntity> CHESS                              = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Reference.MODID, "chess"), FabricBlockEntityTypeBuilder.create(ChessTileEntity::new, TTCBlockEntities.getBlocksOfClass(ChessBlock.class)).build(null));
    ...
    public static final BlockEntityType<ChessTimerBlockEntity> CHESS_TIMER                  = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Reference.MODID, "chess_timer"), FabricBlockEntityTypeBuilder.create(ChessTimerBlockEntity::new, TTCBlockEntities.getBlocksOfClass(ChessTimerBlock.class)).build(null));
    public static final BlockEntityType<ConnectFourBlockEntity> CONNECT_FOUR                = Registry.register(Registry.BLOCK_ENTITY_TYPE, new ResourceLocation(Reference.MODID, "connect_four"), FabricBlockEntityTypeBuilder.create(ConnectFourBlockEntity::new, TTCBlockEntities.getBlocksOfClass(ConnectFourBlock.class)).build(null));
    ...
    private static Block[] getBlocksOfClass(Class<?> clazz)
    {
        ...
        Registry.BLOCK.forEach(blockRO -> {
