...
public class ChessBoardLegalMoveColorButton extends Button
{
	...
	private final String buttonTileInfoColorText = Component.translatable("gui.table_top_craft.chess.color.button.legal_move").getString();
	...
	public ChessBoardLegalMoveColorButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
