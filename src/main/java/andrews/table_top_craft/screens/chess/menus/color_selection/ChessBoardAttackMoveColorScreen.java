...
public class ChessBoardAttackMoveColorScreen extends Screen
{
	...
	private final String colorSelectionText = new TranslatableComponent("gui.table_top_craft.chess.color.attack_move").getString();
	...
	public ChessBoardAttackMoveColorScreen(ChessTileEntity chessTileEntity)
	{
	...
	protected void init()
	{
	    ...
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getAttackMoveColor())));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getAttackMoveColor())));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getAttackMoveColor())));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(x + 5, y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessTileEntity.getAttackMoveColor())));
	    ...
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.ATTACK_MOVE, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 69, y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.ATTACK_MOVE, this.chessTileEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, x + 90, y + 113));
	}
	
	//@SuppressWarnings("deprecation") TODO remove if color is not needed
	@Override
	public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
	{
		...
		//RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F); TODO check if it works
		RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
		poseStack.popPose();
