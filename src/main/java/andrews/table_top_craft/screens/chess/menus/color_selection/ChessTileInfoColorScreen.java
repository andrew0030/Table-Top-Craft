...
public class ChessTileInfoColorScreen extends Screen
{
	...
	private final String colorSelectionText = new TranslationTextComponent("gui.table_top_craft.chess.color.tile_info").getString();
...
//	    this.addButton(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getTileInfoColor())));
	    this.addButton(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getTileInfoColor())));
	    this.addButton(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getTileInfoColor())));
	    this.addButton(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 100, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getTileInfoColor())));
	    ...
	    this.addButton(new ChessResetColorButton(DefaultColorType.TILE_INFO_COLOR, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 69, y + 47));
	    ...
	    this.addButton(new ChessConfirmColorButton(ColorMenuType.TILE_INFO, this.chessTileEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 90, y + 113));
	}
