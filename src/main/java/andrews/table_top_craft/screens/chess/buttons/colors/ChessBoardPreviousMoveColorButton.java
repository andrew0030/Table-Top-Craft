...
public class ChessBoardPreviousMoveColorButton extends Button
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/gui/buttons/chess_menu_buttons.png");
	private final String buttonTileInfoColorText = new TranslationTextComponent("gui.table_top_craft.chess.color.button.previous_move").getString();
	...
	public ChessBoardPreviousMoveColorButton(ChessTileEntity tileEntity, int xPos, int yPos) 
	{
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessBoardPreviousMoveColorScreen(chessTileEntity));
	}
}