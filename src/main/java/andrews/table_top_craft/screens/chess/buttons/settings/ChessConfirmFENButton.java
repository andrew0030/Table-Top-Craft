...
public class ChessConfirmFENButton extends Button
{
	...
	private final String buttonText = new TranslationTextComponent("gui.table_top_craft.chess.confirm_fen").getString();
	private final FontRenderer fontRenderer;
	private static ChessTileEntity chessTileEntity;
	private static TextFieldWidget fenStringField;
	private static final int buttonWidth = 82;
	private static final int buttonHeight = 13;
	private int u = 0;
	private int v = 0;
	
	public ChessConfirmFENButton(ChessTileEntity tileEntity, TextFieldWidget textFieldWidget, int xPos, int yPos) 
	{
	...
	{	
		...
		this.active = true;
		if(fenStringField.getText().isEmpty())
		{
			this.active = false;
			this.u = 164;
		}
	...
	private static void handleButtonPress()
	{
		if(!fenStringField.getText().isEmpty())
		{
			NetworkUtil.loadFENMessage(chessTileEntity.getPos(), fenStringField.getText());
