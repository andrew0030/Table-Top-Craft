...
public class ChessLoadFENButton extends Button
{
	...
	private final String buttonText = new TranslationTextComponent("gui.table_top_craft.chess.load_fen").getString();
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessLoadFENScreen(chessTileEntity));
	}
}