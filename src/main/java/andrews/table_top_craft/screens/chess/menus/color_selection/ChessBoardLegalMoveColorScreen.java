...
public class ChessBoardLegalMoveColorScreen extends Screen
{
	...
	private final String colorSelectionText = new TranslatableComponent("gui.table_top_craft.chess.color.legal_move").getString();
	...
	public ChessBoardLegalMoveColorScreen(ChessTileEntity chessTileEntity)
	{
	...
	protected void init()
	{
	    ...
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getLegalMoveColor())));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getLegalMoveColor())));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getLegalMoveColor())));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(x + 5, y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessTileEntity.getLegalMoveColor())));
	    ...
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.LEGAL_MOVE, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, x + 69, y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.LEGAL_MOVE, this.chessTileEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, x + 90, y + 113));
	}
