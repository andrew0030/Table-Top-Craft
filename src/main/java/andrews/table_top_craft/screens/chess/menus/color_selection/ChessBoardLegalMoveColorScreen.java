...
public class ChessBoardLegalMoveColorScreen extends Screen implements IColorPicker
{
	...
	private final String colorSelectionText = Component.translatable("gui.table_top_craft.chess.color.legal_move").getString();
	...
	protected void init()
	{
	    ...
	    // RGBA Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessBlockEntity.getLegalMoveColor()), this));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(x + 5, y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessBlockEntity.getLegalMoveColor())));
		
		// The Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, x + 69, y + 33));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.LEGAL_MOVE, this, x + 69, y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.LEGAL_MOVE, this.chessBlockEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, x + 90, y + 113));
	...
	public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
	{
		...
		if(isColorPickerActive)
		{
			...
			this.blit(poseStack, x - 136, y - 10, 0, 0, 139, 151);
		}
