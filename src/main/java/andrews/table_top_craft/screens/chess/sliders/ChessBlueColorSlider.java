...
public class ChessBlueColorSlider extends BaseSlider
{
	private final static Component BLUE_TXT = Component.translatable("gui.table_top_craft.chess.sliders.blue");
    private final Screen screen;

    public ChessBlueColorSlider(int pX, int pY, int width, int height, int currentValue, Screen screen)
    {
        super(pX, pY, width, height, BLUE_TXT, Component.literal(""), 0, 255, currentValue, true);
        this.screen = screen;
    }
