...
public class ChessBoardInvalidMoveColorButton extends Button
{
	...
	private final String buttonTileInfoColorText = new TranslatableComponent("gui.table_top_craft.chess.color.button.invalid_move").getString();
	...
	{
		Minecraft.getInstance().setScreen(new ChessBoardInvalidMoveColorScreen(chessTileEntity));
	}
}