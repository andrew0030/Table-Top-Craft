...
public class ChessBoardPieceNextSetButton extends Button
{
    ...
    private final TranslatableComponent buttonText = new TranslatableComponent("gui.table_top_craft.chess_piece_figure.next_set");
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(isHovered)
            Minecraft.getInstance().screen.renderTooltip(poseStack, Arrays.asList(buttonText.getVisualOrderText()), x - 8 + width, y + 14, this.fontRenderer);
    }
