...
public class ChessBoardTilesColorButton extends Button
{
	...
	private final String buttonText = Component.translatable("gui.table_top_craft.chess.color.button.tiles").getString();
	...
	public ChessBoardTilesColorButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
