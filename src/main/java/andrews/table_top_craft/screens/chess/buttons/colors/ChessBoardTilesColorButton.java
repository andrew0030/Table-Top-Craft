...
public class ChessBoardTilesColorButton extends Button
{
	...
	private final String buttonText = new TranslatableComponent("gui.table_top_craft.chess.color.button.tiles").getString();
	...
	{
		Minecraft.getInstance().setScreen(new ChessBoardTilesColorScreen(chessTileEntity));
	}
}