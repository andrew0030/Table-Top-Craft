...
public class ChessTimerResetButton extends Button
{
    ...
    public ChessTimerResetButton(ChessTimerBlockEntity blockEntity, int x, int y)
    {
        super(x, y, 70, 14, Component.literal(""), Button::onPress);
    ...
    public void renderButton(PoseStack poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        if(blockEntity.getLeftTimer() == 1800000 && blockEntity.getRightTimer() == 1800000)
            this.active = false;
