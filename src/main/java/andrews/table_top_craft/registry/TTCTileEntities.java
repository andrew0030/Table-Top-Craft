...
{
	public static final BlockEntityType<ChessTileEntity> CHESS                              = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, new ResourceLocation(Reference.MODID, "chess"), FabricBlockEntityTypeBuilder.create(ChessTileEntity::new, TTCBlocks.OAK_CHESS, TTCBlocks.SPRUCE_CHESS, TTCBlocks.BIRCH_CHESS, TTCBlocks.JUNGLE_CHESS, TTCBlocks.ACACIA_CHESS, TTCBlocks.DARK_OAK_CHESS, TTCBlocks.CRIMSON_CHESS, TTCBlocks.WARPED_CHESS).build(null));
