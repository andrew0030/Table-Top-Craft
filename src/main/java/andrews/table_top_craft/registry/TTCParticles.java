...
{
    public static final ParticleType<ChessShatterParticleOptions> CHESS_SHATTER     = Registry.register(Registry.PARTICLE_TYPE, new ResourceLocation(Reference.MODID, "chess_shatter"), new ParticleType<>(false, ChessShatterParticleOptions.DESERIALIZER) {
        @Override
    ...
    public static final SimpleParticleType TINY_POOF            = Registry.register(Registry.PARTICLE_TYPE, new ResourceLocation(Reference.MODID, "tiny_poof"), FabricParticleTypes.simple());
