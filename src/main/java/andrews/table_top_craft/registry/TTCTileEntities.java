...
public class TTCTileEntities
{
    ...
    public static final RegistryObject<BlockEntityType<ChessTimerBlockEntity>> CHESS_TIMER                  = BLOCK_ENTITY_TYPES.register("chess_timer", () -> new BlockEntityType<>(ChessTimerBlockEntity::new, Sets.newHashSet(TTCBlocks.WHITE_CHESS_TIMER.get()), null));
