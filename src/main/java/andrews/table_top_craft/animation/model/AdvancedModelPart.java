...
public class AdvancedModelPart extends ModelPart
{
    ...
    public Matrix4f getMatrix4f(Entity entity)
    {
        ...
        if(entity != null)
            poseStack.mulPose(Vector3f.YN.rotationDegrees(Mth.lerp(Minecraft.getInstance().getPartialTick(), ((LivingEntity) entity).yBodyRotO, ((LivingEntity) entity).yBodyRot)));
