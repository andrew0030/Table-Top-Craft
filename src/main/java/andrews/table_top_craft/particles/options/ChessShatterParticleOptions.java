...
public class ChessShatterParticleOptions implements ParticleOptions
{
    ...
    // Deserializer
    public static final Deserializer<ChessShatterParticleOptions> DESERIALIZER = new Deserializer<>()
    {
        @Override
    ...
    {
        return String.format(Locale.ROOT, "%s %d %d %d", Registry.PARTICLE_TYPE.getKey(this.getType()), this.red, this.green, this.blue);
    }
