...
public class ChessBoardAttackMoveColorButton extends Button
{
	...
	private final String buttonTileInfoColorText = new TranslationTextComponent("gui.table_top_craft.chess.color.button.attack_move").getString();
	...
	public ChessBoardAttackMoveColorButton(ChessTileEntity tileEntity, int xPos, int yPos) 
	{
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessBoardAttackMoveColorScreen(chessTileEntity));
	}
}