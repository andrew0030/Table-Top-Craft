...
public class ChessShowTileInfoButton extends Button
{
	...
	public ChessShowTileInfoButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
	...
	public void renderWidget(PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
	{
		...
		this.u = 0;
		if(chessBlockEntity.getShouldShowTileInfo())
			this.u = 13;
	...
	{
		NetworkUtil.showTileInfoMessage(chessBlockEntity.getBlockPos());
	}
}