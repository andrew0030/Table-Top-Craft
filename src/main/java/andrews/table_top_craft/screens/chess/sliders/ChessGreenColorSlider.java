...
public class ChessGreenColorSlider extends Slider
{
	private final static TranslationTextComponent greenValueText = new TranslationTextComponent("gui.table_top_craft.chess.sliders.green");

	public ChessGreenColorSlider(int xPos, int yPos, int width, int height, int currentValue)
	{
		super(xPos, yPos, width, height, greenValueText, new StringTextComponent(""), 1, 255, currentValue, false, true, slider -> {});
	}
