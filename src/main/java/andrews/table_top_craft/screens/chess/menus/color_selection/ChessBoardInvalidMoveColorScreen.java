...
public class ChessBoardInvalidMoveColorScreen extends Screen implements IColorPicker
{
	...
	private final String colorSelectionText = new TranslatableComponent("gui.table_top_craft.chess.color.invalid_move").getString();
	...
	public ChessBoardInvalidMoveColorScreen(ChessTileEntity chessTileEntity, boolean isColorPickerActive)
	{
	...
	protected void init()
	{
		...
		// RGBA Sliders
	    this.addRenderableWidget(this.redColorSlider = new ChessRedColorSlider(x + 5, y + 61, 167, 12, NBTColorSaving.getRed(this.chessTileEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.greenColorSlider = new ChessGreenColorSlider(x + 5, y + 74, 167, 12, NBTColorSaving.getGreen(this.chessTileEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.blueColorSlider = new ChessBlueColorSlider(x + 5, y + 87, 167, 12, NBTColorSaving.getBlue(this.chessTileEntity.getInvalidMoveColor()), this));
	    this.addRenderableWidget(this.alphaColorSlider = new ChessAlphaColorSlider(x + 5, y + 100, 167, 12, NBTColorSaving.getAlpha(this.chessTileEntity.getInvalidMoveColor())));
		
		// The Buttons in the Gui Menu
	    this.addRenderableWidget(new ChessRandomColorButton(this, x + 69, y + 33));
	    this.addRenderableWidget(new ChessResetColorButton(DefaultColorType.INVALID_MOVE, this, x + 69, y + 47));
	    ...
	    this.addRenderableWidget(new ChessConfirmColorButton(ColorMenuType.INVALID_MOVE, this.chessTileEntity, this.redColorSlider, this.greenColorSlider, this.blueColorSlider, this.alphaColorSlider, x + 90, y + 113));
