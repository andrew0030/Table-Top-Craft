...
public class ChessBoardColorSettingsButton extends Button
{
	...
	private final TranslationTextComponent buttonText = new TranslationTextComponent("gui.table_top_craft.chess.button.colors");
	...
	{
		this.active = true;
		if(Minecraft.getInstance().currentScreen instanceof ChessColorSettingsScreen)
			this.active = false;
