...
public class ChessEvaluateBoardButton extends Button
{
	...
	private final String buttonText = Component.translatable("gui.table_top_craft.chess.evaluate").getString();
	...
	public ChessEvaluateBoardButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
	...
	private static void handleButtonPress()
	{
		if(chessBlockEntity.getBoard() != null)
		{
			Minecraft.getInstance().setScreen(new ChessBoardEvaluatorScreen(chessBlockEntity));
		}
	}
}