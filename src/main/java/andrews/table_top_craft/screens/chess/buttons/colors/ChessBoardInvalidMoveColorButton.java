...
public class ChessBoardInvalidMoveColorButton extends Button
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID + ":textures/gui/buttons/chess_menu_buttons.png");
	private final String buttonTileInfoColorText = new TranslationTextComponent("gui.table_top_craft.chess.color.button.invalid_move").getString();
	...
	{
		Minecraft.getInstance().displayGuiScreen(new ChessBoardInvalidMoveColorScreen(chessTileEntity));
	}
}