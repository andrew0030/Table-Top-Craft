...
public class ChessCopyFENButton extends Button
{
	...
	private final String buttonText = Component.translatable("gui.table_top_craft.chess.copy_fen").getString();
	...
	public ChessCopyFENButton(ChessBlockEntity tileEntity, int xPos, int yPos)
	{
	...
	private static void handleButtonPress()
	{
		if(chessBlockEntity.getBoard() != null)
		{
			String FENString = FenUtil.createFENFromGame(chessBlockEntity.getBoard());
